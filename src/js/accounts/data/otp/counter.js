...
function dataGetCounter(options) {
  try {
    ...
    if (!period || period < 1) {
      console.warn(
        "[data-otp-options] dataGetCounter: invalid period, using default",
        options.period,
      );
    ...
    console.warn("[data-otp-options] dataGetCounter failed", error);
    return 0;
  }
}

export { dataGetCounter };
