...
import { USER_MENU_SIGN_IN_ABSOLUTE_CLASS } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_CHROME_HIDDEN_CLASS } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_CHROME_PREPARING_CLASS } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_CHROME_VISIBLE_CLASS } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_DOTS_FADE_IN_MS } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_DOTS_FADE_OUT_MS } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_DOTS_RUN_MS } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_EXPAND_FULL_MS } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_EXPAND_UP_MS } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_FADE_MS } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_FADING_CHROME_CLASS } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_LOCKED_CLASS } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_PHASE_EXPAND_FULL_CLASS } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_PHASE_EXPAND_UP_CLASS } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_PHASE_SHRINK_ORIGIN_CLASS } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_PHASE_SHRINK_PADDING_CLASS } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_RESTORE_FADE_MS } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_RESULT_DRAW_CLASS } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_RESULT_HIDE_CLASS } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_RESULT_DRAW_MS } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_RESULT_FADE_OUT_MS } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_RUNNING_CLASS } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_SHRINK_ORIGIN_MS } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_SHRINK_PADDING_MS } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_STATUS_LOADING_IN_CLASS } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_STATUS_LOADING_OUT_CLASS } from "../user-menu-constants.js";
...
import { USER_MENU_SIGN_IN_CHROME_SELECTORS } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_CONTENT_PHASE_CLASSES } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_LAYOUT_VARS } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_EXPAND_HEIGHT } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_EXPAND_LEFT } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_EXPAND_TOP } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_EXPAND_WIDTH } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_FULL_HEIGHT } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_FULL_LEFT } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_FULL_TOP } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_FULL_WIDTH } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_ORIGIN_HEIGHT } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_ORIGIN_LEFT } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_ORIGIN_TOP } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_ORIGIN_WIDTH } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_RESTORE_HEIGHT } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_RESTORE_LEFT } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_RESTORE_TOP } from "../user-menu-constants.js";
import { USER_MENU_VAR_SIGN_IN_RESTORE_WIDTH } from "../user-menu-constants.js";
import { USER_MENU_SIGN_IN_ANIMATION_RUN_ID } from "../user-menu-constants.js";

// Clears transient sign-in animation state from panel and content elements.
export function userMenuSignInAnimationReset(panel, content) {
  if (!panel) {
    return;
  }

  panel.classList.remove(
    USER_MENU_SIGN_IN_FADING_CHROME_CLASS,
    USER_MENU_SIGN_IN_CHROME_HIDDEN_CLASS,
    USER_MENU_SIGN_IN_CHROME_PREPARING_CLASS,
    USER_MENU_SIGN_IN_CHROME_VISIBLE_CLASS,
  );

  panel.querySelectorAll(USER_MENU_SIGN_IN_CHROME_SELECTORS).forEach((element) => {
...
export async function userMenuSignInAnimation(resultIsSuccess) {
  ...
  userMenuSignInAnimationReset(panel, content);
  ...
  try {
    ...
    const shrinkPaddingMs = cssMs(panel,USER_MENU_VAR_SIGN_IN_SHRINK_PADDING_MS);
    const shrinkOriginMs = cssMs(panel,USER_MENU_VAR_SIGN_IN_SHRINK_ORIGIN_MS);
    ...
    status.classList.remove(
      USER_MENU_SIGN_IN_STATUS_LOADING_IN_CLASS,
      USER_MENU_SIGN_IN_STATUS_LOADING_OUT_CLASS,
      "is-shown",
      USER_MENU_SIGN_IN_RESULT_DRAW_CLASS,
      USER_MENU_SIGN_IN_RESULT_HIDE_CLASS,
      "is-animating",
      "is-drawn",
    );
  });

    panel.classList.add(USER_MENU_SIGN_IN_FADING_CHROME_CLASS);
  await delay(signInFadeMs);
  panel.classList.remove(USER_MENU_SIGN_IN_FADING_CHROME_CLASS);
  panel.classList.add(USER_MENU_SIGN_IN_CHROME_HIDDEN_CLASS);
  ...
  content.style.setProperty(USER_MENU_VAR_SIGN_IN_RESTORE_HEIGHT, `${layout.originHeight}px`);
    ...
    content.classList.add(USER_MENU_SIGN_IN_PHASE_EXPAND_UP_CLASS);
    ...
    content.classList.remove(USER_MENU_SIGN_IN_PHASE_EXPAND_UP_CLASS);
    ...
    content.classList.add(USER_MENU_SIGN_IN_PHASE_EXPAND_FULL_CLASS);
    await waitForAnimationEnd(
      content,
      "signInExpandFull",
    ...
    content.classList.remove(USER_MENU_SIGN_IN_PHASE_EXPAND_FULL_CLASS);
    ...
    loadingStatus.classList.add(USER_MENU_SIGN_IN_STATUS_LOADING_IN_CLASS);
    await waitForAnimationEnd(
      loadingStatus,
      "loginStatusFadeIn",
      dotsFadeInMs + USER_MENU_ANIMATION_TIMEOUT_BUFFER_MS,
    );
    loadingStatus.classList.remove(USER_MENU_SIGN_IN_STATUS_LOADING_IN_CLASS);
    ...
    loadingStatus.classList.add(USER_MENU_SIGN_IN_STATUS_LOADING_OUT_CLASS);
    await waitForAnimationEnd(
      loadingStatus,
      "loginStatusFadeOut",
      dotsFadeOutMs + USER_MENU_ANIMATION_TIMEOUT_BUFFER_MS,
    );
    loadingStatus.classList.remove(USER_MENU_SIGN_IN_STATUS_LOADING_OUT_CLASS);
    ...
    resultStatus.classList.add(USER_MENU_SIGN_IN_RESULT_HIDE_CLASS);
    await waitForAnimationEnd(
      resultStatus,
      "loginStatusFadeOut",
    ...
    content.classList.add(USER_MENU_SIGN_IN_PHASE_SHRINK_PADDING_CLASS);
    await waitForAnimationEnd(
      content,
      "signInShrinkPadding",
    ...
    content.style.setProperty(USER_MENU_VAR_SIGN_IN_ORIGIN_WIDTH, `${layout.expandUpWidth}px`);
    content.style.setProperty(USER_MENU_VAR_SIGN_IN_ORIGIN_HEIGHT, `${layout.expandUpHeight}px`);
    content.classList.remove(USER_MENU_SIGN_IN_PHASE_SHRINK_PADDING_CLASS);
    ...
    content.classList.add(USER_MENU_SIGN_IN_PHASE_SHRINK_ORIGIN_CLASS);
    await waitForAnimationEnd(
      content,
      "signInShrinkOrigin",
    ...
    content.style.setProperty(USER_MENU_VAR_SIGN_IN_ORIGIN_WIDTH, `${layout.originWidth}px`);
    content.style.setProperty(USER_MENU_VAR_SIGN_IN_ORIGIN_HEIGHT, `${layout.originHeight}px`);
    content.classList.remove(USER_MENU_SIGN_IN_PHASE_SHRINK_ORIGIN_CLASS);
    ...
    await waitForNextFrame();
    panel.classList.add(USER_MENU_SIGN_IN_CHROME_PREPARING_CLASS);
    panel.classList.remove(USER_MENU_SIGN_IN_CHROME_HIDDEN_CLASS);
    void panel.offsetWidth;
    panel.classList.add(USER_MENU_SIGN_IN_CHROME_VISIBLE_CLASS);
