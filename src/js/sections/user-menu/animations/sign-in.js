...
/** Runs the sign-in auth sequence inside the user menu panel. */
async function userMenuSignInAnimation(resultIsSuccess, onPreRestore) {
...
export { userMenuSignInAnimation };
