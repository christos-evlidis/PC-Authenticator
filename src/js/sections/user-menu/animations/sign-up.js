...
/** Runs the sign-up auth sequence inside the user menu panel. */
async function userMenuSignUpAnimation(resultIsSuccess, onPreRestore) {
...
export { userMenuSignUpAnimation };
