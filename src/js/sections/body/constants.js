...
export const BODY_SPLASH_SELECTOR = ".app-body__splash";
...
export const BODY_TYPING_CLASS = "is-typing";
export const BODY_POPPING_CLASS = "is-popping";
export const BODY_SPLASH_FADING_CLASS = "is-splash-fading-out";

export const FRAME_INTRO_CLASS = "is-frame-intro";
...
export const BODY_VAR_INTRO_SPLASH_HOLD_MS = "--body-intro-splash-hold-ms";
export const BODY_VAR_SPLASH_FADE_MS = "--body-splash-fade-ms";
export const BODY_VAR_INTRO_INSET_MS = "--body-intro-inset-ms";
export const BODY_VAR_INTRO_SLOT_MS = "--body-intro-header-slot-ms";
