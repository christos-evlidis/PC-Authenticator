...
export const BODY_VAR_SIGNED_OUT_TEXT_TYPE_MS = "--body-signed-out-text-type-ms";
export const BODY_VAR_SIGNED_IN_ICON_POP_MS = "--body-signed-in-icon-pop-ms";
export const BODY_VAR_SIGNED_IN_TEXT_TYPE_MS = "--body-signed-in-text-type-ms";
export const BODY_VAR_ANIMATE_FOR_LOGO_HOLD_MS = "--body-animate-for-logo-hold-ms";
export const BODY_VAR_LOGO_FADE_MS = "--body-logo-fade-ms";
export const BODY_VAR_ANIMATE_FOR_EXTENSION_FRAME_MS = "--body-animate-for-extension-frame-ms";
export const BODY_VAR_ANIMATE_FOR_HEADER_MS = "--body-animate-for-header-ms";
