import {
  QR_SETUP_ROOT_SELECTOR,
  QR_SETUP_BACKDROP_SELECTOR,
  QR_SETUP_PANEL_SELECTOR,
  QR_SETUP_HEADER_SELECTOR,
  QR_SETUP_CONTENT_SELECTOR,
  QR_SETUP_BODY_SELECTOR,
  QR_SETUP_CLOSE_BTN_SELECTOR,
  QR_SETUP_OPEN_BTN_SELECTOR,
  QR_SETUP_GUIDE_SELECTOR,
  QR_SETUP_GUIDE_TEXT_SELECTOR,
  QR_SETUP_STATUS_LOADING_SELECTOR,
  QR_SETUP_STATUS_SUCCESS_SELECTOR,
  QR_SETUP_STATUS_ERROR_SELECTOR,
  QR_SETUP_STATUS_ICON_CIRCLE_SELECTOR,
  QR_SETUP_STATUS_ICON_MARK_SELECTOR,
} from "./qr-code-setup.constants.js";
