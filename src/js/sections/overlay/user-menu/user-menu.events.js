...
import { userMenuAuthSwitch } from "./action/user-menu.view.js";
import { userMenuThemeSwitch } from "./action/user-menu.view.js";
...
function userMenuEventsBind() {
  ...
  dom.themeBtns.forEach((button) => {
    button.addEventListener("click", (event) => {
      ...
      void userMenuThemeSwitch(event.currentTarget.dataset.theme);
    });
  });
