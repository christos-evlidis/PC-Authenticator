...
import { USER_MENU_SIGN_OUT_EXPAND_EXTENSION_CLASS } from "../../user-menu-const.js";
...
import { USER_MENU_SIGN_OUT_SHRINK_TO_FULL_CLASS } from "../../user-menu-const.js";
...
import { USER_MENU_VAR_SIGN_OUT_EXPAND_EXTENSION_MS } from "../../user-menu-const.js";
...
import { USER_MENU_VAR_SIGN_OUT_EXTENSION_HEIGHT } from "../../user-menu-const.js";
import { USER_MENU_VAR_SIGN_OUT_EXTENSION_LEFT } from "../../user-menu-const.js";
import { USER_MENU_VAR_SIGN_OUT_EXTENSION_TOP } from "../../user-menu-const.js";
import { USER_MENU_VAR_SIGN_OUT_EXTENSION_WIDTH } from "../../user-menu-const.js";
...
import { USER_MENU_VAR_SIGN_OUT_SHRINK_TO_FULL_MS } from "../../user-menu-const.js";
...
async function userMenuAnimationAuthSignOut(onPreRestore) {
  ...
  try {
    ...
    const expandExtensionMs = animCssMsGet(panel, USER_MENU_VAR_SIGN_OUT_EXPAND_EXTENSION_MS);
    ...
    const shrinkToFullMs = animCssMsGet(panel, USER_MENU_VAR_SIGN_OUT_SHRINK_TO_FULL_MS);
  ...
  content.style.setProperty(USER_MENU_VAR_SIGN_OUT_EXTENSION_TOP, `${layout.extensionTop}px`);
  content.style.setProperty(USER_MENU_VAR_SIGN_OUT_EXTENSION_LEFT, `${layout.extensionLeft}px`);
  content.style.setProperty(USER_MENU_VAR_SIGN_OUT_EXTENSION_WIDTH, `${layout.extensionWidth}px`);
  content.style.setProperty(USER_MENU_VAR_SIGN_OUT_EXTENSION_HEIGHT, `${layout.extensionHeight}px`);
  ...
  content.style.setProperty(USER_MENU_VAR_SIGN_OUT_RESTORE_HEIGHT, `${layout.originHeight}px`);
    ...
    content.classList.add(USER_MENU_SIGN_OUT_EXPAND_EXTENSION_CLASS);
    await animAnimationEndWait(
      content,
      "signInExpandExtension",
      expandExtensionMs + timeoutBufferMs,
    );
    content.style.setProperty(USER_MENU_VAR_SIGN_OUT_ORIGIN_TOP, `${layout.extensionTop}px`);
    content.style.setProperty(USER_MENU_VAR_SIGN_OUT_ORIGIN_LEFT, `${layout.extensionLeft}px`);
    content.style.setProperty(USER_MENU_VAR_SIGN_OUT_ORIGIN_WIDTH, `${layout.extensionWidth}px`);
    content.style.setProperty(USER_MENU_VAR_SIGN_OUT_ORIGIN_HEIGHT, `${layout.extensionHeight}px`);
    content.classList.remove(USER_MENU_SIGN_OUT_EXPAND_EXTENSION_CLASS);
    ...
    content.classList.add(USER_MENU_SIGN_OUT_SHRINK_TO_FULL_CLASS);
    await animAnimationEndWait(
      content,
      "signInShrinkToFull",
    ...
    content.style.setProperty(USER_MENU_VAR_SIGN_OUT_ORIGIN_WIDTH, `${layout.fullWidth}px`);
    content.style.setProperty(USER_MENU_VAR_SIGN_OUT_ORIGIN_HEIGHT, `${layout.fullHeight}px`);
    content.classList.remove(USER_MENU_SIGN_OUT_SHRINK_TO_FULL_CLASS);
