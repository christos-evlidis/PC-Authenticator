...
function userMenuAnimationCleanup() {
  ...
  root?.classList.remove(
    UM.USER_MENU_SIGN_IN_LOCKED_CLASS,
  ...
  if (panel) {
    panel.classList.remove(
      UM.USER_MENU_SIGN_IN_RUNNING_CLASS,
      UM.USER_MENU_SIGN_IN_FADE_CLASS,
      UM.USER_MENU_SIGN_IN_RESTORE_FADE_CLASS,
      UM.USER_MENU_SIGN_UP_RUNNING_CLASS,
      UM.USER_MENU_SIGN_UP_FADE_CLASS,
      UM.USER_MENU_SIGN_UP_RESTORE_FADE_CLASS,
      UM.USER_MENU_SIGN_OUT_RUNNING_CLASS,
      UM.USER_MENU_SIGN_OUT_FADE_CLASS,
      UM.USER_MENU_SIGN_OUT_RESTORE_FADE_CLASS,
      UM.USER_MENU_PANEL_OPENING_CLASS,
      UM.USER_MENU_PANEL_OPEN_CLASS,
      UM.USER_MENU_PANEL_CLOSING_CLASS
    );
    const allFadeSelectors = new Set([
      UM.USER_MENU_SIGN_IN_FADE_SELECTORS,
      UM.USER_MENU_SIGN_UP_FADE_SELECTORS,
      UM.USER_MENU_SIGN_OUT_FADE_SELECTORS
    ]);
    panel.querySelectorAll([...allFadeSelectors].join(",")).forEach((element) => {
  ...
  if (content) {
    animPhaseReset(
      content,
      ...UM.USER_MENU_SIGN_IN_CONTENT_PHASE_CLASSES,
      ...UM.USER_MENU_SIGN_UP_CONTENT_PHASE_CLASSES,
      ...UM.USER_MENU_SIGN_OUT_CONTENT_PHASE_CLASSES,
      UM.USER_MENU_SIGN_IN_ABSOLUTE_CLASS,
      UM.USER_MENU_SIGN_UP_ABSOLUTE_CLASS,
      UM.USER_MENU_SIGN_OUT_ABSOLUTE_CLASS
    );
    const allLayoutVars = new Set([
      ...UM.USER_MENU_SIGN_IN_LAYOUT_VARS,
      ...UM.USER_MENU_SIGN_UP_LAYOUT_VARS,
      ...UM.USER_MENU_SIGN_OUT_LAYOUT_VARS
    ]);
    allLayoutVars.forEach((layoutVar) => {
  ...
  [statusLoading, statusSuccess, statusError].forEach((status) => {
    ...
    status.classList.remove(
      UM.USER_MENU_SIGN_IN_DOTS_FADE_IN_CLASS,
      UM.USER_MENU_SIGN_IN_DOTS_RUN_CLASS,
      UM.USER_MENU_SIGN_IN_DOTS_FADE_OUT_CLASS,
      UM.USER_MENU_SIGN_IN_RESULT_DRAW_CLASS,
      UM.USER_MENU_SIGN_IN_RESULT_FADE_OUT_CLASS,
      UM.USER_MENU_SIGN_UP_DOTS_FADE_IN_CLASS,
      UM.USER_MENU_SIGN_UP_DOTS_RUN_CLASS,
      UM.USER_MENU_SIGN_UP_DOTS_FADE_OUT_CLASS,
      UM.USER_MENU_SIGN_UP_RESULT_DRAW_CLASS,
      UM.USER_MENU_SIGN_UP_RESULT_FADE_OUT_CLASS,
      UM.USER_MENU_SIGN_OUT_DOTS_FADE_IN_CLASS,
      UM.USER_MENU_SIGN_OUT_DOTS_RUN_CLASS,
      UM.USER_MENU_SIGN_OUT_DOTS_FADE_OUT_CLASS,
      UM.USER_MENU_SIGN_OUT_RESULT_DRAW_CLASS,
      UM.USER_MENU_SIGN_OUT_RESULT_FADE_OUT_CLASS,
      "is-animating",
      "is-drawn"
    );
  });
