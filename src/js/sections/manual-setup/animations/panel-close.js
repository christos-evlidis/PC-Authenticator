...
/** Runs the slide-then-unblur close sequence for the manual setup overlay. */
async function manualSetupPanelCloseAnimation() {
...
export { manualSetupPanelCloseAnimation };
