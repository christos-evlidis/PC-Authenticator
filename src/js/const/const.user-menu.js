import { VAR_BLUR_MS, VAR_BUFFER_MS, VAR_DOTS_RUN_MS, VAR_EXPAND_FULL_MS, VAR_EXPAND_UP_MS, VAR_FADE_MS, VAR_HOLD_MS, VAR_RESULT_MAIN_DRAW_MS, VAR_SHRINK_DOWN_MS, VAR_SHRINK_FULL_MS, VAR_SLIDE_MS } from "./const.utility.js";
...
export const USER_MENU_THEME_VIEW_LIGHT = "light";
export const USER_MENU_THEME_VIEW_DARK = "dark";

// Shared state classes.
export const USER_MENU_HIDDEN_CLASS = "is-hidden";
export const USER_MENU_VIEW_ACTIVE_AUTH = "is-active";
export const USER_MENU_VIEW_ACTIVE_THEME = "is-active";
